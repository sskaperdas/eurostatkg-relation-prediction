...
class ComplexModelWithRotatE(nn.Module):
    def __init__(self, num_entities, num_relations, embedding_dim, rot_embedding_dim, dropout_rate=0.5, l2_reg=0.01):
        ...
        # Placeholder for flatten size (lazy init in first forward pass)
    ...
    def forward(self, inputs):
        ...
        # Combine scores into a 2-channel sequence for Conv1D
        ...
        # Lazy initialization of dense1 (requires input shape)
        ...
        return torch.sigmoid(self.dense2(x))  # Output shape: (B, 1)
...
classifier = ComplexModelWithRotatE(num_entities, num_relations, EMBEDDING_DIM, EMBEDDING_DIM).to(DEVICE)
