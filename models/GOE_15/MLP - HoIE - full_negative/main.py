...
class MLPHoIE(nn.Module):
    def __init__(self, num_entities, num_relations, embedding_dim, num_types, dropout_rates=None):
        ...
        # === Ontology-aware GAT Layer (REPLACES GCN) ===
        ...
        self.batch_norm = nn.BatchNorm1d(512 + 256 + 512)

        # === Fully Connected Layers ===
        layer_sizes = [1280, 2048, 1024, 512, 256, 128]
    ...
    def forward(self, h, r, t):
        ...
        # === Apply GAT to entity embeddings ===
    ...
    def score_triple(self, h, r, t):
        ...
        return self.fc_out(x).squeeze(-1)  # Raw score (before sigmoid)
