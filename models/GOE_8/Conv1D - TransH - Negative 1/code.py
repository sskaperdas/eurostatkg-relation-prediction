...
class TransHConvModel(nn.Module):
    def __init__(self, num_entities, num_relations, embedding_dim, projection_dim, num_types, dropout_rate=0.5):
        ...
        self.flatten_dim = 256 * (embedding_dim * 4)  # Assuming 4 vectors concatenated
